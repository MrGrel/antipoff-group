  ...
  <div className="partner-page">
    <header className="header">
      <div className="container header__container">
        ...
        <button className="header__btn-back">Вернуться</button>
        ...
        <section className="section partner">
          <div className="partner__container">
            <p className="partner__text">
              ...
              том, что после окончания проекта у клиента есть все необходимое, чтобы дальше развиваться самостоятельно"{' '}
              <br />
